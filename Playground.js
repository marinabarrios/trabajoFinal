...
const algo = sesionInteligencia.recibirArticulo(futureOfProjectManagement);
console.log ('Se recibió el artículo',algo);
/** SE VERIFICA SI EL AUTOR TIENE NOTIFICACIONES DE RECHAZADO SOBRE SU ARTICULO */
console.log(matias.obtenerNotificaciones());
